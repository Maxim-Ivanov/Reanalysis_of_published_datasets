...
RNA_seq_BAM_to_normalized_bedGraph <- function(bamfile, mode = "PE", stranded = TRUE, switch_strand = TRUE, normalize = TRUE, norm_to = 1e06) {
...
cov_list <- lapply(bamfiles, RNA_seq_BAM_to_normalized_bedGraph)

# For stranded SE data (e.g. Kohnen et al., 2016 - PMID 27923878):
cov_list <- lapply(bamfiles, RNA_seq_BAM_to_normalized_bedGraph, mode = "SE")
